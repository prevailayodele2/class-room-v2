...
const AvatarSuccess = styled(Avatar)(
  ({ theme }) => `
          ...
          color: ${useColorModeValue("#01B574", "#fff" )};
...
const TabsContainerWrapper = styled(Box)(
  ({ theme }) => `
        ...
        .MuiTab-root {
            ...
            &.Mui-selected:hover,
            &.Mui-selected {
                color: ${useColorModeValue("#0b1437", "#fff" )};
            }
        }
  `
);
    ...
    <RootWrapper>
      <Box display="flex" alignItems="flex-start">
        ...
        >
          ...
          >
            <Box>
              <Typography variant="h5" sx={{color: useColorModeValue("#0b1437", "#fff" )}} noWrap>
                {user.name}
              </Typography>
              <Typography variant="subtitle1" sx={{color: useColorModeValue("#0b1437", "#fff" )}} noWrap>
                {user.jobtitle}
              </Typography>
            </Box>
            <IconButton
      ...
      <MeetingBox>
        <Typography variant="h4" sx={{color: useColorModeValue("#0b1437", "#fff" )}}>Monthly Get Together</Typography>
        ...
        <Box py={3} display="flex" alignItems="flex-start">
          ...
          <Box pl={1}>
            ...
            <Typography color={useColorModeValue("#0b1437", "#fff" )} variant="subtitle1">
      ...
      <MeetingBox>
        <Typography sx={{color: useColorModeValue("#0b1437", "#fff" )}} variant="h4">Governors Council Meeting</Typography>
