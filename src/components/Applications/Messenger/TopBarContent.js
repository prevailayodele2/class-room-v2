        ...
        >
          ...
          >
            <Avatar
              ...
              src="/static/images/avatars/1.jpg"
            />
            <Typography variant="h4" sx={{ color: useColorModeValue('#263238', 'white')}}>Zain Baptista</Typography>
            <Typography variant="subtitle2" sx={{ color: useColorModeValue('#263238', 'white')}}>
              Active{' '}
